...
Token smuggling: Se utilizan espacios, tabulacoines, letras mayúsculas... todo para ocultar instrucciones maliciosas y evadir filtros basados en patrones.
Homoglyph smuggling: se utilizan carateres de otros alfabetos visualmente parecidos al latino para evadir filtros de texto y ocultar instrucciones.
